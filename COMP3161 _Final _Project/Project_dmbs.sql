...
-- Triggers
DELIMITER $$ CREATE TRIGGER get_id
AFTER
...
--
--
--Get credentials of specific user
DELIMITER //
CREATE PROCEDURE GetCredentials(IN userName VARHCAR(80))
BEGIN
...
DELIMITER $$
CREATE PROCEDURE regUser(firstname varchar(30), lastname varchar(30), password varchar(20), email varchar(40))
BEGIN
